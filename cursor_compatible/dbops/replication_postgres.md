...
## Overview
This guide describes how to set up streaming replication for PostgreSQL (operational, user, config data) to ensure high availability and disaster recovery.
