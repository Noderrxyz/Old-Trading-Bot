...
/**
 * Interface for paper trading adapters (both regular and enhanced)
 */
export interface IPaperTradingAdapter {
  getPortfolioSnapshot(): PortfolioSnapshot;
  getExecutionHistory(limit?: number): ExecutionReport[];
...
/**
 * Enhanced performance dashboard for paper trading
 * Works with both regular and enhanced paper trading adapters
 */
export class EnhancedPaperTradingDashboard {
  private adapter: IPaperTradingAdapter;
   ...
   * @param adapter Paper trading adapter (regular or enhanced)
   */
  constructor(adapter: PaperTradingAdapter | EnhancedPaperTradingAdapter) {
...
/**
 * Create a console-based dashboard instance that works with either adapter type
 * @param adapter Paper trading adapter (regular or enhanced)
 * @returns Dashboard instance
 */
export function createEnhancedConsoleDashboard(
  adapter: PaperTradingAdapter | EnhancedPaperTradingAdapter
): EnhancedPaperTradingDashboard {
  const dashboard = new EnhancedPaperTradingDashboard(adapter);
