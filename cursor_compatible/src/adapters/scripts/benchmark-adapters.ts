 ...
 */
import { createAdapter, IChainAdapter, Asset } from '../index';
...
const ASSETS: Record<number, { native: Asset, token: Asset }> = {
  1: {
...
async function measurePerformance(adapter: IChainAdapter, chainId: number, chainName: string): Promise<TestResult> {
